...
public class TrailRenderer_Local : MonoBehaviour {
    ...
    public float distIncrement = 0.001f;      // How far should the object move before leaving a new trail point
    ...
    public int maxPositions = 100;           // Set the number of segments here
    ...
    void Update () {
        ...
        Vector3 curPosition = objToFollow.localPosition; // - parentObj.localPosition
